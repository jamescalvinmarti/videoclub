...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        self::seedCategories();
        $this->command->info('Taula de categories emplanada');
    ...
    private function seedCategories()
    {
        ...
        $infantil = new Category;
        $terror = new Category;
        $drama = new Category;

        $infantil->title = 'Infantil';
        $infantil->description = 'per a nens petits';
        $infantil->adult = false;
        $infantil->save();

        $terror->title = 'Terror';
        $terror->description = 'pelis de por';
        $terror->adult = true;
        $terror->save();

        $drama->title = 'Drama';
        $drama->description = 'pelis de drama';
        $drama->adult = false;
        $drama->save();
    }
    ...
    private $arrayPeliculas = array(
        array(
            ...
            'category_id' => 3,
            'trailer' => 'https://www.youtube.com/watch?v=COQvkUmN6H8'
        ),
        array(
        ...
        array(
            ...
            'category_id' => 3,
            'trailer' => 'https://www.youtube.com/watch?v=ZFYCXAG6fdo'
        ),
        array(
        ...
        array(
            ...
            'category_id' => 3,
            'trailer' => 'https://www.youtube.com/watch?v=YlN6mLs6NII'
        ),
        array(
            'title' => 'El pianista',
            'year' => '2002',
